...
{
    #region 잠금. 나중에 노가다 필요할 때 참고할 것
    //public Dictionary<string, string> charDictionary = new Dictionary<string, string>();
    //public Dictionary<string, string> playingCardDictionary = new Dictionary<string, string>();
